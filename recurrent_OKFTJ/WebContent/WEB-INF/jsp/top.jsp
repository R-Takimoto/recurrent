			...
			<div class="col-sm-10">
				<div class="tab-content">
					<div id="photo1" class="tab-pane active">
						<a href="/recurrent/ProductServlet?typeCode=w-002">
							<img src="images/setmenu/setmenu1.jpg" class="img-thumbnail" alt="かつ丼セット" />
						</a>

						<img src="images/setmenu/setmenu2.jpg" class="img-thumbnail" alt="カレーセット" />
					...
					<div id="photo4" class="tab-pane">
						<img src="images/drink/drink.jpg" class="img-thumbnail" alt="" />
